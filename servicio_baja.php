...
<html>
<head><title>BAJAS DE SERVICIO</title>
</head>
<body bgcolor="aqua">
</script>
...
<h2>BAJA SERVICIO</h2>
<form action="baja_servicio.php" method="POST">
INTRODUCE EL PRECIO DEL SERVICIO: <br><br>
<input type="numerico" name="PRECIO_SER"><br>
